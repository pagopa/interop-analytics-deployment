...
DROP MATERIALIZED VIEW IF EXISTS sub_views.00_mv_client_tenant_authserver_ips__oldest_ts;

CREATE MATERIALIZED VIEW sub_views.00_mv_client_tenant_authserver_ips__oldest_ts AUTO REFRESH YES as
