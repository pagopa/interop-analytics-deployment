...
DROP MATERIALIZED VIEW IF EXISTS views.00_mv_service_endpoint_method_ms_elapsed;

CREATE MATERIALIZED VIEW views.00_mv_service_endpoint_method_ms_elapsed AUTO REFRESH YES AS 
select 
