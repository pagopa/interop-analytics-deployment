...
DROP MATERIALIZED VIEW IF EXISTS sub_views.mv_client_tenant_authserver_ips__oldest_ts;

CREATE MATERIALIZED VIEW sub_views.mv_client_tenant_authserver_ips__oldest_ts AUTO REFRESH YES as
