...
DROP MATERIALIZED VIEW IF EXISTS views.mv_02_eservice_without_token__final CASCADE;
...
GRANT SELECT ON TABLE views.mv_02_eservice_without_token__final TO interop_analytics_quicksight_user;
